...
const uint64_t ADDR_NCC1 = 0x51000000;
const uint64_t ADDR_DMA  = 0x60000000;

const uint64_t ADDR_DDR  = 0x00000000;

const uint64_t BRAM_TMP_COARSE = 0x10000;
const uint64_t BRAM_SEG_FULL   = 0x80000;
const uint64_t BRAM_SEG_COARSE = 0x90000;

const uint64_t REG_IMG_W     = 0x00;
const uint64_t REG_IMG_H     = 0x04;
const uint64_t REG_TMP_W     = 0x08;
const uint64_t REG_TMP_H     = 0x0C;
const uint64_t REG_IMG_ADDR  = 0x10;
const uint64_t REG_TMP_ADDR  = 0x14;
