...
const uint64_t ADDR_NCC  = 0x50000000;   // NCC blok 0
const uint64_t ADDR_NCC1 = 0x51000000;   // NCC blok 1 (paralelna jedinica)
const uint64_t ADDR_DMA  = 0x60000000;

// PS Adresni prostor
const uint64_t ADDR_DDR  = 0x00000000;

// BRAM raspored (offseti unutar BRAM-a)
const uint64_t BRAM_TMP_COARSE = 0x10000;  // grubi (2x smanjeni) šabloni
const uint64_t BRAM_SEG_FULL   = 0x80000;  // pun 90x90 segment (DMA)
const uint64_t BRAM_SEG_COARSE = 0x90000;  // grubi 45x45 segment (CPU upisuje)
