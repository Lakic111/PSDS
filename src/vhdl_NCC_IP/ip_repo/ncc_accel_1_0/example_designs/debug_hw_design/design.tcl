...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: ncc_accel_0, and set properties
	set ncc_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ncc_accel:1.0 ncc_accel_0 ]
	...
	# Connect all clock & reset of ncc_accel_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ncc_accel_0/S00_AXI]
	connect_bd_net [get_bd_pins ncc_accel_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ncc_accel_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins ncc_accel_0/S01_AXI]
	connect_bd_net [get_bd_pins ncc_accel_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ncc_accel_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to ncc_accel_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ncc_accel_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ncc_accel_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ncc_accel_0_S01_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:ncc_accel:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ncc_accel_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ncc_accel_hw_${i}"
