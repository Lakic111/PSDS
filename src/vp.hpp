...
public:
    ...
    sc_core::sc_event& ncc0Done() { return ncc0->done_ev; }
    sc_core::sc_event& ncc1Done() { return ncc1->done_ev; }
    sc_core::sc_event& dmaDone()  { return dma->done_ev; }

private:
    sys_bus* bus;
    NCC_Target* ncc0;   // NCC blok 0
    NCC_Target* ncc1;   // NCC blok 1 (paralelna jedinica)
    BRAM_Module* bram;
    DDR_Module* ddr;
    DMA_Module* dma;
